export const translations = {
  ar: {
    ...
    distanceMultiplier: 'معامل معايرة المسافة (العداد)',
    distanceMultiplierDesc: 'اضبط الرقم ده لو قراءة البرنامج بتختلف عن عداد السكوتر (مثلاً 1.05)',
  ...
  en: {
    ...
    distanceMultiplier: 'Distance Calibration Multiplier',
    distanceMultiplierDesc: 'Adjust this if the app distance differs from your scooter\'s odometer (e.g. 1.05)',
